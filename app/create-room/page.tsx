          ...
          <div className="glass-card rounded-2xl p-8">
            ...
            <div className="mb-8">
              <div className="w-14 h-14 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center mb-4">
                <Plus className="text-indigo-400" size={28} strokeWidth={1.5} />
              </div>
              <h1 className="text-2xl font-semibold text-white mb-2">Create a New Room</h1>
              <p className="text-neutral-400 text-sm">
                Set up a space where you and others can collaborate on blog posts
              </p>
            </div>
            ...
            <form onSubmit={handleCreateRoom} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-neutral-500">
                  3-100 characters. This will be used to generate a URL-friendly slug.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  disabled={loading}
                  rows={4}
                  className="w-full px-4 py-3 bg-neutral-900 border border-white/10 rounded-lg text-white placeholder:text-neutral-500 focus:outline-none focus:border-indigo-500/50 transition-colors disabled:opacity-50 resize-none"
                />
              </div>

              <div className="bg-indigo-500/5 border border-indigo-500/20 p-4 rounded-lg">
                <div className="flex gap-3">
                  <Info className="text-indigo-400 flex-shrink-0" size={18} strokeWidth={1.5} />
                  <p className="text-sm text-indigo-300">
                    <strong className="font-semibold">Note:</strong> A unique 4-digit join code will be automatically generated
                    for your room. Share this code with others to invite them.
                  </p>
                </div>
              </div>
